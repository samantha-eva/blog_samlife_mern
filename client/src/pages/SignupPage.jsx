        ...
        <div className='w-full h-full flex flex-col items-center justify-center py-12 px-4 sm:px-0 lg:px-8'>
          ...
          <div className='w-full space-y-6 flex flex-col justify-start'>
            <div className='w-full flex gap-3 md:gap-4 items-center justify-start mb-12'>
              ...
              <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900 dark:text-white">Inscription pour créer un compte</h2>
            </div>
            {showForm ? (
              <form 
              ...
              >
                ...
                <Button
                  ...
                  border-transparent text-sm font-medium rounded-full text-white bg-black dark:bg-rose-800 
            ...
            <div className="max-w-md w-full space-y-8">
             <Button
              ...
              bg-black dark:bg-transparent dark:border 
              text-white px-5 py-2.5 rounded-full'
            />
            <Divider label="OU"/>
            <Button
              onClick={() => setShowForm(true)}
              label='Continuer avec votre adresse'
              styles='w-full gap-4 bg-white text-black
              dark:bg-rose-800 dark:text-white px-5 py-2.5
              rounded-full bordee dark:border-none
              border-gray-300'
            />
            </div>
            )}
